  ...
  return (
    <div className="space-y-20 pb-20 overflow-hidden">
      ...
      <section className="relative pt-12 pb-24 lg:pt-20 lg:pb-32 px-4 sm:px-6 lg:px-8">
        {/* Soft Ambient Background Orbs with Subtle Parallax */}
        <ScrollReveal variant="parallax" className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
          <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-gradient-to-tr from-brand-600/15 to-accent-teal/15 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute top-40 right-10 w-96 h-96 bg-brand-500/10 rounded-full blur-3xl pointer-events-none" />
        </ScrollReveal>

        <div className="max-w-6xl mx-auto text-center space-y-6">
          {/* Eyebrow badge */}
          <ScrollReveal variant="fade-down" triggerOnLoad delay={0.05}>
          ...
          {/* Master Headline (Word-by-word Masked Slide-up) */}
          <AnimatedText
            as="h1"
            type="hero"
            triggerOnLoad
            delay={0.15}
            className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.15] font-['Outfit']"
          >
          ...
          <AnimatedText
            ...
            triggerOnLoad
            delay={0.35}
            className="max-w-3xl mx-auto text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed"
          >
          ...
          <ScrollReveal variant="fade-up" triggerOnLoad delay={0.45} className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <a
              href="#search-panel"
          ...
          <ScrollReveal variant="scale-in" triggerOnLoad delay={0.6} id="search-panel" className="pt-8 max-w-4xl mx-auto">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal variant="fade-up" className="glass-card rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-[#0B132B]/60 border border-slate-200/70 dark:border-slate-800">
          <div className="text-center max-w-2xl mx-auto mb-8">
            <span className="text-xs font-bold uppercase tracking-wider text-brand-600 dark:text-brand-400">
              Structured Discovery Architecture
            </span>
            <AnimatedText as="h2" showAccentLine accentLineClassName="h-1 bg-gradient-to-r from-brand-600 to-accent-teal rounded-full mt-2 w-16 mx-auto" className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white font-['Outfit'] mt-1">
              How You Discover Commercial Real Estate
            </AnimatedText>
            <AnimatedText as="p" type="fade-up" delay={0.15} className="text-sm text-slate-600 dark:text-slate-300 mt-2">
          ...
          <ScrollReveal variant="stagger" stagger={0.08} className="grid grid-cols-2 md:grid-cols-5 gap-3 text-center">
            <div className="scroll-reveal-item p-4 rounded-2xl bg-white/60 dark:bg-slate-900/60 border border-slate-200/60 dark:border-slate-800 flex flex-col items-center">
            ...
            <div className="scroll-reveal-item col-span-2 md:col-span-1 p-4 rounded-2xl bg-brand-500/10 border border-brand-500/30 flex flex-col items-center">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          <div>
            ...
            <AnimatedText as="h2" showAccentLine className="text-3xl font-extrabold text-slate-900 dark:text-white font-['Outfit'] mt-1">
              Commercial Property Categories
            </AnimatedText>
            <AnimatedText as="p" type="fade-up" delay={0.1} className="text-sm text-slate-600 dark:text-slate-300 mt-1">
        ...
        <ScrollReveal variant="stagger" stagger={0.1} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((cat) => {
            const Icon = cat.icon;
            return (
              <Link
                key={cat.id}
                to={cat.path}
                className="scroll-reveal-item glass-card glass-card-hover rounded-3xl p-6 flex flex-col justify-between group border border-slate-200/90 dark:border-slate-800/90 bg-white/70 dark:bg-[#0B132B]/75 transition-all will-change-transform"
              >
                <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal variant="stagger" stagger={0.1} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal variant="fade-up">
          <div className="relative rounded-3xl overflow-hidden glass-card p-8 sm:p-12 border border-brand-500/30 bg-gradient-to-br from-brand-900/90 via-navy-950 to-slate-950 text-white shadow-2xl">
            <ScrollReveal variant="slide-left" delay={0.15} className="relative z-10 max-w-2xl space-y-4">
              ...
              <AnimatedText as="h2" className="text-3xl sm:text-4xl font-extrabold font-['Outfit'] tracking-tight">
                Can't Find Your Exact Floor Area or Location?
              </AnimatedText>
              <AnimatedText as="p" type="fade-up" delay={0.1} className="text-sm sm:text-base text-slate-300 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal variant="stagger" stagger={0.12} className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="scroll-reveal-item glass-card glass-card-hover rounded-3xl p-6 border border-slate-200/80 dark:border-slate-800 bg-white/70 dark:bg-[#0B132B]/70 will-change-transform">
            ...
            <AnimatedCounter value={10} suffix="+ Years Experience" className="text-2xl font-extrabold text-brand-600 dark:text-brand-400 block mb-1 font-['Outfit']" />
          ...
          <div className="scroll-reveal-item glass-card glass-card-hover rounded-3xl p-6 border border-slate-200/80 dark:border-slate-800 bg-white/70 dark:bg-[#0B132B]/70 will-change-transform">
            ...
            <AnimatedCounter value={500} suffix="+ Site Inspections" className="text-2xl font-extrabold text-accent-teal block mb-1 font-['Outfit']" />
            <h3 className="text-lg font-bold text-slate-900 dark:text-white font-['Outfit']">
          ...
          <div className="scroll-reveal-item glass-card glass-card-hover rounded-3xl p-6 border border-slate-200/80 dark:border-slate-800 bg-white/70 dark:bg-[#0B132B]/70 will-change-transform">
            ...
            <AnimatedCounter value={100} suffix="% Transparency" className="text-2xl font-extrabold text-indigo-500 block mb-1 font-['Outfit']" />
            <h3 className="text-lg font-bold text-slate-900 dark:text-white font-['Outfit']">
